  ...
  <div class="wrapper">
    <div class="title">
      ...
      <div class="title__content">
        <div class="title__content__info">Edit the shipping address</div>
        <div class="title__content__more" @click="handleDeleteClick">delete</div>
      </div>
    </div>
    <div class="address">
      ...
      <div class="address__item">
        ...
        <input
          type="text"
          placeholder="Please fill in the full addres"
...
import VDistpicker from "v-distpicker"; //引入第三方地区三级联动组件
...
const useAddressEffect = (showToast) => {
  ...
  const handleSaveClick = async () => {
    const result = await request.post("/user/address/update", {
      id: address.id,
      userId: userInfo.id,
