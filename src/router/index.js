...
const routes = [
  ...
  },
  {
    ...
    name: "PreDinner",
    component: () =>
      import(/* webpackChunkName: "PreDinner" */ "../views/home/PreDinner"),
  },
  {
    path: "/newTitle",
    name: "newTitle",
    component: () =>
      import(/* webpackChunkName: "PreDinner" */ "@/components/newTitle"),
  },
  {
    path: "/newLogin",
    name: "newLogin",
    component: () =>
      import(/* webpackChunkName: "PreDinner" */ "@/components/newLogin"),
  },
  {
    path: "/wait/:sort",
    name: "Wait",
    component: () =>
      import(/* webpackChunkName: "Wait" */ "../views/home/Wait"),
  },
  {
    path: "/in",
    name: "In",
    component: () =>import(/* webpackChunkName: "In" */ "../views/home/In"),
  },
  {
...
router.beforeEach((to, from, next) => {
  ...
  isLogin || flag ? next() : next({ name: "Login" });
});
